...
function IndPost({ post }) {
  ...
  return (
    ...
    >
      <div className="bg-gray-800/20 py-7 pl-20 mt-10 ">
        <h1 className="text-5xl text-white">{posts.title}</h1>
      </div>
      <div className="bg-gray-800/20 py-10 pl-20 mt-10">
        <p className="text-left text-white text-2xl w-4/6">{posts.content}</p>
      </div>
    </div>
  );
}
