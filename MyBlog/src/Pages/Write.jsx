  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center text-center">
        <h1 className="text-white text-4xl mt-10 mb-7">Thoughts on paper</h1>
        ...
        <div className="flex justify-center mb-10">
          <input
            ...
            className="w-xl border border-gray-300 rounded-lg text-white text-center text-3xl p-5"
            value={title}
        ...
        <div className="flex justify-center">
          <textarea
            ...
            className="w-xl h-100 border border-gray-300 rounded-lg text-white  text-xl p-5"
          ></textarea>
        </div>
        <div className="flex justify-center">
          <button
            className="text-white  rounded-4xl mt-5 mb-20 py-1 px-7 transition duration-400 hover:bg-gray-800"
            onClick={handlePublish}
          >
            <Link to="/read">Publish</Link>
          </button>
        </div>
      </div>
    </div>
