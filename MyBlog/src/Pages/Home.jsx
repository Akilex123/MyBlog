  ...
  return (
    ...
    >
      <div className="ml-30 mt-30 mb-20">
        <h1 className="text-9xl text-white">OurStory</h1>
        <h1 className="text-8xl text-white mb-5">& ideas</h1>
        <h4 className="text-3xl text-white mb-10">
          A place to read, write and deepen your understanding
        </h4>
        <button className="text-center text-2xl text-black bg-white p-3 px-9 rounded-4xl  duration-300 hover:bg-black hover:text-white">
